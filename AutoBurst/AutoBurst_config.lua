...
AssistedPlayer = "" -- IF LEFT BLANK IT WILL SCAN THE PARTY FOR A MEMBER ENGAGED AND USE THAT

AttemptMyrkr = true -- SET TO TRUE TO USE MYRKYR OR FALSE TO NOT ( NOT YET IMPLEMENTED )
